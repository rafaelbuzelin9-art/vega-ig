...
SLIDES = {
    "capa": {
        "bg": "capa.png", "claro": False, "txt_top": 176,
        "obj": ["Você revê o tráfego", "Depois o atendimento", "O resultado continua o mesmo"],
        "sub": "Talvez o problema nunca tenha sido uma pessoa.",  # 1 linha
    },
    "capa-b": {
        "bg": "capa.png", "claro": False, "txt_top": 190,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "volume": {
        "bg": "volume.png", "claro": True, "txt_top": 210,
    ...
    "capa-c": {   # mesmo layout da B, recorte vindo do Image Decompose
        "bg": "capa2.png", "claro": False, "txt_top": 190,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "arco": {   # estátua inteira e descida, legenda curvada no globo
        # headline sobe: o arco externo tem topo em y=358 e a headline em 176
        # terminava em 344, encostando. 130 devolve ~60px de respiro.
        "bg": "arco.png", "claro": False, "txt_top": 118, "nu": True,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        # Copy condensada em duas linhas. Cada linha a menos tira um raio
        # inteiro do arco externo, e é essa folga que paga o corpo maior.
        "arco": {"json": "fundos/arco.json", "folga": 48, "entre": 58,
                 "corpo": 42, "peso": 300, "cor": "#E7DCC6",
                 # Júri: 5 de 5 mataram o verbo "revê" (é verbo de agência, não
                 # do dono — ele TROCA) e 5 de 5 apontaram a assimetria 32/29.
                 # 24/24 deixa os semicírculos concêntricos de verdade, e as
                 # pontas ficam com palavras curtas, que é onde o arco inclina.
                 "linhas": ["Você troca quem carrega.",
                            "O peso continua o mesmo."]},
    },
    "arco-b": {   # alternativa do júri: nomeia agência e time
        # com o wordmark de volta à esquerda, 118px punha a headline em cima
        # dele. 165 abre 46px do logo e ainda deixa 70px até o arco.
        "bg": "arco@2x.png", "hires": True,
        "claro": False, "txt_top": 165, "nu": True,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        # ângulo ~= comprimento do texto / raio. A 54px o arco dava 167° e as
        # pontas viravam. Corpo menor encurta o texto e folga maior abre o
        # raio: as duas coisas puxam o ângulo para baixo ao mesmo tempo.
        # colar no globo encurta o raio e, sozinho, devolveria o ângulo a 145°;
        # o corpo cai junto para segurar a leitura das pontas
        "arco": {"json": "fundos/arco.json", "folga": 44, "entre": 60,
                 "corpo": 42, "peso": 300, "cor": "#E7DCC6",
                 "linhas": ["Você troca a agência, o time.",
                            "O resultado continua o mesmo."]},
    },
    # --- arranjos sobre a BASE-vega: grid e logo já vêm no fundo ---
    "arranjo-1": {   # estátua descida, texto no campo de cima
        "bg": "arranjo-1.png", "claro": False, "txt_top": 176, "nu": True,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "arranjo-2": {   # estátua cheia, texto por cima do mármore
        "bg": "arranjo-2.png", "claro": False, "txt_top": 1010, "nu": True,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "arranjo-3": {   # estátua inteira e pequena, texto acima dela
        "bg": "arranjo-3.png", "claro": False, "txt_top": 176, "nu": True,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "capa-d": {   # sem caixa: fundo preto puro, texto sobreposto à cena
        "bg": "capa3.png", "claro": False, "txt_top": 190,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    "capa-e": {   # idem, com o Atlas subindo mais para invadir o texto
        "bg": "capa3alto.png", "claro": False, "txt_top": 140,
        "obj": ["Talvez o problema nunca", "Tenha sido uma *pessoa*"],
        "sub": "Você revê o tráfego. Depois, o atendimento.|O resultado continua o mesmo.",
    },
    # SLIDE 02 FINAL: a cena é um componente nosso, não uma imagem gerada.
    # A base entra crua (o bg sobe um nível porque a BASE mora fora de fundos/)
    "volume": {
    ...
    # --- SLIDE 02 (volume): tres cenas de marmore em teste, mesma copy ---
    # o texto sobe pro mesmo topo do slide 01 (165) pra manter a linha do
    # carrossel; sub em duas linhas com quebra controlada
    **{f"vol-{k}": {
        "bg": f"vol-{k}.png", "claro": False, "txt_top": 165, "nu": True,
        "obj": ["O problema não é a tarefa", "É o *volume*"],
        "sub": "Um minuto por confirmação. Dois por retomada.|"
               "Cinco por horário vago. Dezenas de vezes, todos os dias.",
    } for k in "abc"},
    # --- 03 a 06: copy fechada, fundo ainda MOCK (fundos_mock.py) ---
    "arcos": {
        "bg": "arcos.png", "claro": False, "txt_top": 196,
        "obj": ["O que se repete todo dia", "Vira *estrutura*"],
        "sub": "Não é gente fazendo mais rápido.|"
               "É a operação passando a acontecer sozinha.",
    },
    "sistema": {
        "bg": "sistema.png", "claro": False, "txt_top": 186, "corpo": 68,
        "obj": ["Quatro coisas deixaram", "De depender de alguém *lembrar*"],
        "itens": ["Confirma o compromisso e registra",
                  "Ocupa o horário que vagou na hora",
                  "Volta a falar três dias depois",
                  "Diz quem chamar hoje e por quê"],
    },
    "freio": {
        "bg": "freio.png", "claro": True, "txt_top": 200,
        "obj": ["E o que ele nunca faz", "*Sozinho*"],
        "sub": "Não escreve fora de hora.|Não insiste com quem pediu pra parar.|"
               "Não decide nada que peça julgamento humano.",
    },
    "fecho": {
        "bg": "fecho.png", "claro": False, "txt_top": 200, "corpo": 68,
        "obj": ["Trocar de gente conserta um dia", "Trocar o processo conserta o *mês*"],
        "sub": "Da aquisição à operação. Um sistema só.|"
               "@vegasystems · Diagnóstico do Sistema",
    },
}
...
{'' if cfg.get("nu") else f'<div class="logo">{(DS / "assets" / logo).read_text(encoding="utf-8")}</div>'}
